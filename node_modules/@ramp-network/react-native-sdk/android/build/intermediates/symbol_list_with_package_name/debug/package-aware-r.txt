...
animator mb_card_flip_blinkid_1
animator mb_card_flip_blinkid_2
...
attr maxVelocity
attr maxWidth
attr mb_animateRotation
attr mb_animationDuration
attr mb_aspectRatio
attr mb_backSideInstructionsDrawable
attr mb_backSideSplashDrawable
attr mb_blinkcardEditConfirmButtonStyle
attr mb_blinkcardEditDividerColor
attr mb_blinkcardEditErrorColor
attr mb_blinkcardEditErrorTextAppearance
attr mb_blinkcardEditLabelTextAppearance
attr mb_blinkcardEditLabelTextColor
attr mb_blinkcardEditToolbarBackground
attr mb_blinkcardEditToolbarNavigationIcon
attr mb_blinkcardEditToolbarTheme
attr mb_blinkcardEditValueHintColor
attr mb_blinkcardEditValueTextAppearance
attr mb_blinkcardEditValueTextColor
attr mb_borderColor
attr mb_borderWidth
attr mb_btnCornerRadius
attr mb_btnTimeoutColor
attr mb_btnTimeoutTextAppearance
attr mb_captureButtonDrawable
attr mb_cardBackDrawable
attr mb_cardFrontDrawable
attr mb_circleCheckFailedColor
attr mb_circleColor
attr mb_circleOuterColor
attr mb_circleProgressColor
attr mb_circleSuccessColor
attr mb_cornerRadius
attr mb_detectionRectangleColor
attr mb_errorHookColor
attr mb_errorIcon
attr mb_exitScanDrawable
attr mb_flashlightWarningBackgroundDrawable
attr mb_flashlightWarningTextAppearance
attr mb_flipCardColor
attr mb_frontSideInstructionsDrawable
attr mb_frontSideSplashDrawable
attr mb_glareWarningBackgroundDrawable
attr mb_glareWarningTextAppearance
attr mb_hookColor
attr mb_innerColor
attr mb_instructionsBackgroundDrawable
attr mb_instructionsTextAppearance
attr mb_outerColor
attr mb_overlayColor
attr mb_progressDrawable
attr mb_pulseColor
attr mb_reticleDefaultDrawable
attr mb_reticleErrorDrawable
attr mb_reticleSuccessDrawable
attr mb_rotatable
attr mb_scanLineColor
attr mb_shapeType
attr mb_successFlashColor
attr mb_successIcon
attr mb_torchOffDrawable
attr mb_torchOnDrawable
...
color action_btn_back
color action_btn_back_disable
color action_btn_text
color action_btn_text_black
...
color mb_background
color mb_bg_status_message
color mb_black
color mb_blinkid_status_bg
color mb_blinkid_status_bg_error
color mb_blinkid_status_text
color mb_blue
color mb_blue_dark
color mb_default_frame
color mb_default_selfie_overlay_shape_border_color
color mb_default_selfie_overlay_shape_inner_color
color mb_default_selfie_overlay_shape_outer_color
color mb_document_detection_quad
color mb_max_quality_ocr_color
color mb_med_quality_ocr_color
color mb_min_quality_ocr_color
color mb_mrz_point_color
color mb_overlay_camera_translucent
color mb_recognized_frame
color mb_snackbar_bg
color mb_status_background
color mb_status_foreground
color mb_transparent
color mb_viewfinder_inner_splash
color mb_viewfinder_inner_transparent
color mb_white
...
color panel
color passbase_blue
color passbase_blue_disable
color passbase_header
color passbase_lt_blue
color passbase_lt_gray
color passbase_sub_header
color passbase_title
...
dimen mb_activity_horizontal_margin_verification_flow
dimen mb_button_radius
dimen mb_default_selfie_overlay_shape_border_width
dimen mb_default_selfie_overlay_shape_corner_radius
dimen mb_instructions_line_height
dimen mb_instructions_text_size
dimen mb_margin_tooltip
dimen mb_margin_torch_button
dimen mb_padding_small
dimen mb_padding_standard
dimen mb_padding_tooltip
dimen mb_pulse_size_offset
dimen mb_pulse_stroke_width
dimen mb_radius_status_msg_background
dimen mb_snackbar_corner_radius
dimen mb_snackbar_margin
dimen mb_snackbar_padding
dimen mb_snackbar_text_size
...
dimen passbaseBtnLogo
dimen test_mtrl_calendar_day_cornerSize
dimen textActionButton
dimen textByPassbase
dimen textCountriesByAlphabet
dimen textCountryItem
dimen textSizeMicroblinkHint
dimen textSmall
dimen textTextCloseSubTitle
dimen textTextCloseTitle
dimen textTextSubTitle
dimen textTextSubTitleReuseDoc
dimen textTextTerms
dimen textTextTitle
dimen textTextTitleReuseDoc
...
drawable ag
drawable ai
drawable aic_arrow_down
drawable aic_arrow_left
drawable aic_arrow_left_dark
drawable aic_arrow_left_normal
drawable aic_arrow_up
drawable aic_back
drawable aic_back_dark
drawable aic_back_zoom
drawable aic_cancel
drawable aic_chooser
drawable aic_circle_reusable_email
drawable aic_consent_gradient
drawable aic_error_logo
drawable aic_flash
drawable aic_frame_bottom_left
drawable aic_frame_left_top
drawable aic_frame_right_bottom
drawable aic_frame_top_right
drawable aic_info
drawable aic_mb_card_back
drawable aic_mb_card_front
drawable aic_mb_ok
drawable aic_micribl_flash_off
drawable aic_micribl_flash_on
drawable aic_microbl_anim
drawable aic_p_back_dark
drawable aic_passbase_check_box
drawable aic_passbase_check_box_false
drawable aic_passbase_check_box_true
drawable aic_passbase_logo
drawable aic_passbaseicon
drawable aic_passport
drawable aic_progress_bar
drawable aic_progress_bar_dark
drawable aic_rect_passbase_button
drawable aic_rect_top_round
drawable aic_round_circle
drawable aic_round_circle_border
drawable aic_round_circle_prepare
drawable aic_round_info
drawable aic_round_info_dark
drawable aic_round_rect
drawable aic_round_rect_border_solid_x2
drawable aic_round_rect_border_solid_x2_dark
drawable aic_round_rect_border_x2
drawable aic_triangle
drawable aic_triangle_dark
drawable al
drawable am
drawable ao
drawable ar
...
drawable bf
drawable bg
drawable bg_bottom_sheet_rounded
drawable bg_liveness_action_msg
drawable bg_mb_action_message
drawable bg_round_rect_outlined
drawable bh
drawable bhutan_1
drawable bi
drawable bj
...
drawable ic_logo_passbase
drawable ic_logo_passbase_liveness
drawable ic_mb_flash_off
drawable ic_mb_flash_on
...
drawable ly
drawable ma
drawable mb_backid_white
drawable mb_bg_status_msg_verification_flow
drawable mb_blinkid_status_bg
drawable mb_camera_denied
drawable mb_card_back
drawable mb_card_front
drawable mb_dot
drawable mb_frontid_white
drawable mb_gradient_overlay
drawable mb_help
drawable mb_help_default
drawable mb_help_pressed
drawable mb_ic_exit
drawable mb_ic_flash_off_24dp
drawable mb_ic_flash_on_24dp
drawable mb_powered_by
drawable mb_reticle_default
drawable mb_reticle_error
drawable mb_reticle_progress
drawable mb_reticle_success
drawable mb_rounded_border
drawable mb_snackbar_bg
drawable mc
drawable md
drawable me
drawable mg
...
drawable sg
drawable si
drawable simple_button_bg
drawable simple_button_text_state
drawable sk
drawable sl
drawable sm
drawable sn
...
id buttonPanel
id camera_ask_main
id camera_ask_permission_button
id cancel_button
id cardAnimationView
id carryVelocity
...
id defaultHelpButton
id defaultStatusTextSwitcher
id defaultTorchButton
id default_activity_button
id default_photopay_viewfinder
id deltaRelative
...
id detectorList
id dialog_button
id dialog_congrats_parent_passbase
id dialog_congrats_tip_passbase
id documentScanInstructions
...
id expanded_menu
id face_detect_background
id face_detect_face
id face_detect_target
id face_detect_target_progress
id face_detect_timeout_progress
id face_parent
id fade
id fill
id filled
...
id info
id instructionsView
id invalid_selfie_container
id invalid_selfie_face_check
id invalid_selfie_only_u_on_picture
id invalid_selfie_retake_video_button
id invalid_selfie_title
id invisible
id italic
...
id largeLabel
id layout
id layout_document_popup_continue
id layout_document_popup_corrective_view
id layout_document_popup_image
id layout_document_popup_image_back
id layout_document_popup_info
id layout_document_popup_info_text1
id layout_document_popup_info_text2
id layout_document_popup_info_text3
id layout_document_popup_no
id layout_document_popup_parent
id left
id light
id line1
id line3
...
id match_parent
id message
id microblink_manual_action_message
id microblink_manual_back_button
id microblink_manual_camera_wrap_container
id microblink_manual_doc_frame_view
id microblink_manual_flash_button
id microblink_manual_liveness_surface
id microblink_manual_scan_button
id microblink_manual_scan_container
id microblink_manual_side_image
id middle
id mini
id month_grid
...
id parentRelative
id parent_matrix
id passbase_action_btn_parent
id passbase_action_btn_progress
id passbase_action_btn_text
id passbase_adapter_doc_border
id passbase_adapter_doc_image
id passbase_adapter_doc_name
id passbase_animation_screen_parent
id passbase_animation_screen_preview_animation
id passbase_button_background
id passbase_button_divider
id passbase_button_logo_container
id passbase_button_logo_img
id passbase_button_logo_txt
id passbase_button_text
id passbase_choose_country_action
id passbase_choose_country_parent
id passbase_choose_country_parent_list
id passbase_choose_country_progress
id passbase_choose_country_scroll
id passbase_choose_country_selector_main_parent
id passbase_choose_country_selector_parent
id passbase_choose_country_text1
id passbase_choose_country_text2
id passbase_choose_country_toolbar
id passbase_close_confirmation_action
id passbase_close_confirmation_image
id passbase_close_confirmation_no
id passbase_close_confirmation_parent
id passbase_close_confirmation_text1
id passbase_close_confirmation_text2
id passbase_close_confirmation_toolbar
id passbase_congrats_done_action
id passbase_congrats_done_animation
id passbase_congrats_done_parent
id passbase_congrats_done_progress
id passbase_congrats_done_text1
id passbase_congrats_done_text2
id passbase_congrats_done_toolbar
id passbase_consent_step_number
id passbase_consent_step_title
id passbase_country_item_218_text
id passbase_country_item_icon
id passbase_country_item_text
id passbase_detect_center_image
id passbase_detect_corner_bottom_left
id passbase_detect_corner_left_top
id passbase_detect_corner_right_bottom
id passbase_detect_corner_top_right
id passbase_enter_email_action
id passbase_enter_email_email
id passbase_enter_email_email_parent
id passbase_enter_email_parent
id passbase_enter_email_progress
id passbase_enter_email_text1
id passbase_enter_email_text2
id passbase_enter_email_toolbar
id passbase_fragment_upload_animation
id passbase_fragment_upload_progress
id passbase_fragment_upload_text
id passbase_include_email_action
id passbase_include_email_email
id passbase_include_email_email_parent
id passbase_include_email_parent
id passbase_include_email_text1
id passbase_include_email_text2
id passbase_include_email_toolbar
id passbase_item_document_hint_img
id passbase_item_document_hint_name
id passbase_item_reusable_resource_check
id passbase_item_reusable_resource_info
id passbase_item_reusable_resource_text
id passbase_item_select_lang_icon
id passbase_item_select_lang_main_parent
id passbase_item_select_lang_open_arrow
id passbase_item_select_lang_parent
id passbase_item_select_lang_parent_list
id passbase_item_select_lang_scroll
id passbase_item_select_lang_txt
id passbase_manual_liveness_face_detect_view
id passbase_manual_liveness_root_container
id passbase_manual_liveness_surface
id passbase_manual_liveness_toolbar
id passbase_microbl_anim
id passbase_microbl_anim_add
id passbase_microbl_back
id passbase_microbl_bg_img
id passbase_microbl_document_confirm
id passbase_microbl_flash
id passbase_microbl_help
id passbase_microbl_hint
id passbase_microbl_scan_btn
id passbase_microbl_scan_layout
id passbase_parent_layout
id passbase_prepare_content_container
id passbase_prepare_content_toolbar
id passbase_prepare_options_nested_container
id passbase_prepare_options_scroll_container
id passbase_prepare_term_1
id passbase_prepare_term_2
id passbase_prepare_verification_action
id passbase_prepare_verification_check
id passbase_prepare_verification_check_scroll
id passbase_prepare_verification_check_scroll_gradient
id passbase_prepare_verification_check_text
id passbase_prepare_verification_language_selector
id passbase_prepare_verification_parent
id passbase_prepare_verification_progress
id passbase_prepare_verification_text1
id passbase_prepare_verification_toolbar
id passbase_reauth_error_action
id passbase_reauth_error_image
id passbase_reauth_error_parent
id passbase_reauth_error_text1
id passbase_reauth_error_text2
id passbase_reauth_error_toolbar
id passbase_reauth_preemail_error_action
id passbase_reauth_preemail_error_image
id passbase_reauth_preemail_error_no
id passbase_reauth_preemail_error_parent
id passbase_reauth_preemail_error_text1
id passbase_reauth_preemail_error_text2
id passbase_reauth_preemail_error_toolbar
id passbase_reusable_resource_action
id passbase_reusable_resource_check_text
id passbase_reusable_resource_email
id passbase_reusable_resource_email_img
id passbase_reusable_resource_img_1
id passbase_reusable_resource_nested_container
id passbase_reusable_resource_parent
id passbase_reusable_resource_progress
id passbase_reusable_resource_scroll_container
id passbase_reusable_resource_text1
id passbase_reusable_resource_text2
id passbase_reusable_resource_tip1
id passbase_scan_back_document_action
id passbase_scan_back_document_animation
id passbase_scan_back_document_back
id passbase_scan_back_document_finish
id passbase_scan_back_document_parent
id passbase_scan_back_document_progress
id passbase_scan_back_document_text1
id passbase_scan_back_document_text2
id passbase_scan_back_document_title
id passbase_scan_front_document_action
id passbase_scan_front_document_animation
id passbase_scan_front_document_parent
id passbase_scan_front_document_progress
id passbase_scan_front_document_text1
id passbase_scan_front_document_text2
id passbase_scan_front_document_toolbar
id passbase_securely_data_transfer_action
id passbase_securely_data_transfer_center
id passbase_securely_data_transfer_img
id passbase_securely_data_transfer_parent
id passbase_securely_data_transfer_progress
id passbase_securely_data_transfer_text1
id passbase_securely_data_transfer_tip
id passbase_securely_data_transfer_toolbar
id passbase_select_document_action
id passbase_select_document_icon
id passbase_select_document_open_arrow
id passbase_select_document_parent
id passbase_select_document_progress
id passbase_select_document_selector_parent
id passbase_select_document_table
id passbase_select_document_table_in_scroll
id passbase_select_document_table_scroll
id passbase_select_document_text1
id passbase_select_document_text2
id passbase_select_document_toolbar
id passbase_select_document_txt
id passbase_select_document_type
id passbase_something_wrong_action
id passbase_something_wrong_image
id passbase_something_wrong_parent
id passbase_something_wrong_text1
id passbase_something_wrong_text2
id passbase_something_wrong_toolbar
id passbase_start_screen_action
id passbase_start_screen_animation
id passbase_start_screen_language_selector
id passbase_start_screen_parent
id passbase_start_screen_progress
id passbase_start_screen_text1
id passbase_start_screen_text2
id passbase_start_screen_toolbar
id passbase_take_selfie_video_action
id passbase_take_selfie_video_animation
id passbase_take_selfie_video_parent
id passbase_take_selfie_video_progress
id passbase_take_selfie_video_reauth_overlay
id passbase_take_selfie_video_text1
id passbase_take_selfie_video_text2
id passbase_take_selfie_video_toolbar
id passbase_toolbar
id passbase_toolbar_back_button
id passbase_toolbar_close_button
id passbase_toolbar_demo
id passbase_toolbar_logo
id passbase_toolbar_logo_parent
id passbase_toolbar_title
id passbase_upload_document_hint_layout
id passbase_upload_document_hint_scroll
id password_toggle
id path
id pathRelative
id percent
...
id react_test_id
id recognizerView
id recognizer_runner_view_container
id rectangle
id rectangles
id restart
id resultLabel
...
integer mb_blinkid_card_flip_fade_duration
integer mb_blinkid_card_flip_fade_out_offset
integer mb_blinkid_card_flip_rotation_duration
integer mb_blinkid_card_scale_duration
integer mb_blinkid_card_scale_half_duration
integer mb_default_shape_type
integer mb_snackbar_animation_duration
...
layout abc_tooltip
layout action_button_passbase
layout activity_animation
layout activity_choose_country_passbase
layout activity_close_confirmation
layout activity_congrats_done
layout activity_consent_screen
layout activity_enter_email_passbase
layout activity_liveness_manual
layout activity_menu_list
layout activity_microbl
layout activity_microbl_custom
layout activity_microblink_manual
layout activity_nfc_detect_passbase
layout activity_re_auth_email_passbase
layout activity_re_auth_error_email_passbase
layout activity_re_auth_error_passbase
layout activity_reusable_resource
layout activity_scan_back_document_passbase
layout activity_scan_front_document_passbase
layout activity_securely_data_transfer_passbase
layout activity_select_document_passbase
layout activity_something_wrong_passbase
layout activity_start_screen_passbase
layout activity_take_selfie_video_passbase
layout bottom_sheet_invalid_selfie
layout country_item_218_countries_item
layout country_item_passbase
...
layout dialog_congrats_tip_passbase
layout document_item_passbase
layout face_detect_view
layout fps_view
layout fragment_scan_corners
layout include_upload_animation
layout item_consent_step
layout item_documet_hint
layout item_reusable_recource
layout item_select_language
layout layout_document_popup
layout mb_activity_scan
layout mb_camera_permission_overlay
layout mb_camera_splash
layout mb_default_camera_overlay
layout mb_default_camera_overlay_with_status
layout mb_overlay_blink_id
layout mb_snackbar_content
layout mb_top_button_bar
layout mb_verification_document_camera_overlay
...
layout passbase_button_passbase
layout redbox_item_frame
layout redbox_item_title
layout redbox_view
layout result_entry
layout result_image_entry
...
layout view_passbase_toolbar
layout widget_activity
plurals mtrl_badge_content_description
raw countries
raw keep
raw le_covid_card
raw le_drivers_license_back
raw le_drivers_license_dropdown
raw le_drivers_license_front
raw le_error
raw le_head
raw le_health_back
raw le_health_front
raw le_lock
raw le_national_id_back
raw le_national_id_dropdown
raw le_national_id_front
raw le_passport_dropdown
raw le_passport_front
raw le_proof_of_address_front
raw le_selfie_animation
raw le_selfie_error
raw le_start
raw le_verified_badge
raw le_verified_liveness
raw selfie_challenge_settings
string COVID_VACCINATION_CARD
string DRIVERS_LICENSE
string HEALTH_INSURANCE_CARD
string HEALTH_INSURANCE_CARD_US
string MBAvailableAccounts
string MBBirthData
string MBDigitalSignature
string MBDigitalSignatureVersion
string MBDocumentBackImageColorStatus
string MBDocumentBackImageMoireStatus
string MBDocumentCaptureTitle
string MBDocumentFrontImageColorStatus
string MBDocumentFrontImageMoireStatus
string MBDocumentImageColorStatus
string MBDocumentImageMoireStatus
string MBDocumentLocation
string MBEncodedFaceImage
string MBEncodedFullDocumentImage
string MBEncodedFullDocumentImageBack
string MBEncodedFullDocumentImageFront
string MBEncodedMrzImage
string MBEncodedSignatureImage
string MBFaceImage
string MBFaceLocation
string MBFormFunction
string MBFormVersion
string MBFullDocumentImage
string MBFullDocumentImageBack
string MBFullDocumentImageFront
string MBHighResImage
string MBMRZImage
string MBRecognitionStatus
string MBSignatureImage
string MBSlovakPaymentInfoKeySuffix
string NATIONAL_ID_CARD
string PASSPORT
string PPAccount
string PPAccountPrefix
string PPAdditionalAddressInformation
string PPAdditionalInformation
string PPAdditionalNameInformation
string PPAddress
string PPAddressChangeDate
string PPAddressCity
string PPAddressHouseNumber
string PPAddressState
string PPAddressStreet
string PPAddressZipCode
string PPAdministrativeUnit
string PPAge
string PPAlienNumber
string PPAlternativeSchemeParameters
string PPAmount
string PPApplicationReceiptNumber
string PPArmyNumber
string PPAuthority
string PPAuthorityType
string PPBIC
string PPBankCode
string PPBankName
string PPBarcodeData
string PPBarcodeRawData
string PPBarcodeType
string PPBelegnummer
string PPBloodGroup
string PPCANNumber
string PPCNP
string PPCURP
string PPCVV
string PPCardVersion
string PPCitizenship
string PPCity
string PPCivilIdNumber
string PPCivilStatusNumber
string PPClass
string PPClassInfoCountry
string PPClassInfoRegion
string PPClassInfoType
string PPCommercialCode
string PPCompanyName
string PPConditions
string PPConstantSymbol
string PPContractAccount
string PPCountryCode
string PPCountryId
string PPCountryOfBirth
string PPCreditorId
string PPCurrency
string PPCurrencyCode
string PPCustomerData
string PPCustomerID
string PPDateOfBirth
string PPDateOfExpiry
string PPDateOfExpiryPermanent
string PPDateOfIssueDlCategoryB
string PPDateOfIssueDlCategoryBNotSpecified
string PPDateOfSignature
string PPDeposit
string PPDetectorResult
string PPDisplayData
string PPDistrict
string PPDistrictCode
string PPDocumentAdditionalNumber
string PPDocumentBilingual
string PPDocumentBothSidesMatch
string PPDocumentClassification
string PPDocumentCode
string PPDocumentForNonResidents
string PPDocumentNumber
string PPDocumentType
string PPDonorIndicator
string PPDriverNumber
string PPDueDate
string PPElectorKey
string PPEmployer
string PPEndorsements
string PPExecutionDate
string PPExtendedBarcodeData
string PPExtendedNRIC
string PPEyeColour
string PPFacultyAddress
string PPFamilyName
string PPFatherName
string PPFingerprint
string PPFirstName
string PPFirstNames
string PPFormFunction
string PPFormID
string PPFormType
string PPFormVersion
string PPFullName
string PPGivenNames
string PPHeight
string PPIBAN
string PPIdentificationCode
string PPIdentityCardNumber
string PPIdentityNumber
string PPImmigrantCaseNumber
string PPInventoryNumber
string PPInvoiceID
string PPIsAlive
string PPIssueDate
string PPIssuedBy
string PPIssuer
string PPIssuerCode
string PPIssuingAgency
string PPIssuingAuthority
string PPKelDesa
string PPLastName
string PPLicenceCategories
string PPLicenceNumber
string PPLicenceType
string PPLicencingAuthority
string PPLocalizedName
string PPMRZParsed
string PPMRZText
string PPMRZVerified
string PPMandateId
string PPMaritalStatus
string PPMaturityDate
string PPMerchantCodeCategory
string PPMerchantReference
string PPMotherName
string PPNRICNumber
string PPName
string PPNationalNumber
string PPNationality
string PPNationalityCode
string PPOccupation
string PPOcrLine
string PPOldNRIC
string PPOneTimePaymentCode
string PPOperationalCode
string PPOpt1
string PPOpt2
string PPOptionalData
string PPOrientationNumber
string PPOwner
string PPParentNames
string PPPassportNumber
string PPPayerAccount
string PPPayerAddress
string PPPayerBankCode
string PPPayerBankName
string PPPayerCity
string PPPayerCountry
string PPPayerDetailedAddress
string PPPayerHouseNumber
string PPPayerIBAN
string PPPayerID
string PPPayerName
string PPPayerPlace
string PPPayerPostalCode
string PPPayerReference
string PPPayerReferenceModel
string PPPayerStreet
string PPPaymentCardNumber
string PPPaymentCode
string PPPaymentDataType
string PPPaymentDescription
string PPPaymentDescriptionCode
string PPPaymentOptions
string PPPaymentStatus
string PPPaymentType
string PPPeriodicFirstExecutionDate
string PPPeriodicLastExecutionDate
string PPPeriodicTimeUnit
string PPPeriodicTimeUnitRotation
string PPPersonalNumber
string PPPlaceOfBirth
string PPPlaceOfIssue
string PPPlaceOfOrigin
string PPPostingKey
string PPPrimaryId
string PPPrincipalResidenceAtIssuance
string PPProcessingCode
string PPProductCode
string PPProfession
string PPProvince
string PPPrufziffer
string PPPurposeCode
string PPRT
string PPRW
string PPRace
string PPRank
string PPRawResult
string PPRecipientAccount
string PPRecipientAddress
string PPRecipientCity
string PPRecipientCountry
string PPRecipientDetailedAddress
string PPRecipientHouseNumber
string PPRecipientName
string PPRecipientPlace
string PPRecipientPostalCode
string PPRecipientStreet
string PPReference
string PPReferenceModel
string PPReferenceNumber
string PPReferenceStatus
string PPReligion
string PPResidence
string PPResidentialStatus
string PPRestrictions
string PPSecondaryId
string PPSector
string PPSerialNo
string PPSeries
string PPServiceCode
string PPSex
string PPSimNumber
string PPSlipID
string PPSortCode
string PPSpecialRemarks
string PPSpecificSymbol
string PPSubscriberNumber
string PPSuccessFrame
string PPSurname
string PPSurnameAtBirth
string PPTaxNumber
string PPTransactionCode
string PPUltimateRecipientAddress
string PPUltimateRecipientCity
string PPUltimateRecipientCountry
string PPUltimateRecipientHouseNumber
string PPUltimateRecipientName
string PPUltimateRecipientPostalCode
string PPUltimateRecipientStreet
string PPUncertain
string PPUtilityID
string PPValidFrom
string PPValidThru
string PPValidUntil
string PPVariableSymbol
string PPVehicleCategories
string PPVehicleClass
string PPVin
string PPWithdraw
...
string bulletCovidVaccinationCardVisible
string bulletDocumentVisible
string bulletDriversLicenseVisible
string bulletHealthInsuranceVisible
string bulletNationalIDVisible
string bulletPassportVisible
string bulletProofOfAddressVisible
string bulletReadable
string button_description
string cameraPermissions
string cameraPermissionsErrorMobile
string cancel
...
string challengeFarDistancePrompt
string challengeFinishSuccess
string challengeHintInitialization
string challengeHintPendingNoFace
string challengeHintPendingOffDownd
string challengeHintPendingOffLeft
string challengeHintPendingOffRight
string challengeHintPendingOffUp
string challengeHintPendingTooClose
string challengeHintPendingTooFar
string challengeHintValidatedSuccessFrst
string challengeHintValidatedSuccessLast
string challengeHintValidation
string challengeInitializer
string challengeInstructionInitialization
string challengeInstructionPending
string challengeInstructionTimeout
string challengeInstructionValidatedSuccess
string challengeInstructionValidation
string challengeStartPromt
string challengeStartSuccess
string challengeTimeout
string challengeValidation
...
string close
string closeStepSubtitle
string closeStepTitle
...
string consentBulletLight
string consentOr
string consentSecurityFooter
string consentTitle
string continueButton
string countriesCount
string countrySelectionSubtitle
string countrySelectionTitle
string default_web_client_id
string demoUiMode
string docsList
string driversLicenseCheck
...
string faceChallengeEmailSubtitle
string faceChallengeEmailTitle
string faceChallengeRetryFailedTitle
string faceChallengeRetrySubtitle
string faceChallengeRetryTitle
string faceVerificationExplanationSubtitleZoom
string faceVerificationExplanationTitleZoom
string facetec_liveness_passed
string finish
string finishedSubtitle
...
string identificationChoiceSubtitle
string identificationChoiceTitle
string image_description
string imagebutton_description
string is_your_email
string link_description
string livenessFailedSubtitle
string livenessFailedTitle
string liveness_button_retake_video
string liveness_invalid_selfie_face_clearly_visible
string liveness_invalid_selfie_only_u_on_picture
string liveness_invalid_selfie_title
string loggedIn
string loginSubtitle
string loginTitle
string mb_activity_title_step_back_side
string mb_activity_title_step_front_side
string mb_autofocus_fail
string mb_blinkid_back_instructions_barcode
string mb_blinkid_camera_flip_document
string mb_blinkid_document_not_fully_visible
string mb_blinkid_document_too_close_to_edge
string mb_blinkid_front_instructions
string mb_camera_not_allowed
string mb_camera_not_ready
string mb_camera_permission_required
string mb_custom_ui_forbidden
string mb_data_not_match_msg
string mb_data_not_match_retry_button
string mb_data_not_match_title
string mb_dismiss_error_dialog
string mb_enable_camera
string mb_enable_permission_help
string mb_enable_permission_help_instant_app
string mb_error_camera_high
string mb_error_camera_near
string mb_error_initializing
string mb_feature_unsupported_android_version
string mb_feature_unsupported_autofocus
string mb_feature_unsupported_device
string mb_flashlight_warning_message
string mb_help_button
string mb_invalid_license
string mb_licence_check_device_offline
string mb_licence_check_failed
string mb_licence_locked
string mb_recognition_timeout_dialog_message
string mb_recognition_timeout_dialog_retry_button
string mb_recognition_timeout_dialog_title
string mb_splash_msg_id_back
string mb_splash_msg_id_front
string mb_tooltip_back_id
string mb_tooltip_front_id
string mb_tooltip_glare
string mb_unsupported_document_message
string mb_unsupported_document_title
string mb_warning_title
...
string nationalIdCheck
string nationalityMessage
string networkError
string not_accepted
string not_available
string ok
string outOfCreditsMobile
string passbase_by_passbase
string passbase_description
string passbase_select_country
string passportCheck
string passportVerificationExplanationSubtitle
string passportVerificationExplanationTitle
...
string pictureUserConfirmationTitle
string prepareCovidVaccinationCard
string prepareDriversLicenseBack
string prepareDriversLicenseFront
string prepareHealthInsuranceBack
string prepareHealthInsuranceFront
string prepareNationalIDBack
string prepareNationalIDFront
string preparePassport
string prepareProofOfAddress
string progressbar_description
string project_id
string radiogroup_description
string redo
string retryFaceChallengeCta
string retryFaceChallengeEmailCta
string retryFaceChallengeRedoEmailCta
string reuseResourceInfoText
string reuseResourceSecondTitle
string reuseResourceTitle
string reuseResourceTooltip
string rn_tab_description
string scanCovidVaccinationCard
string scanDriversLicenseBack
string scanDriversLicenseFront
string scanHealthInsuranceBack
string scanHealthInsuranceFront
string scanNationalIDBack
string scanNationalIDFront
string scanPassport
string scanProofOfAddress
string scanToolTip
string scan_manually_button
...
string start
string startInfoExplanationSubtitle
string startInfoExplanationTitle
...
string summarySelfieVideo
string summaryTitle
string summary_description
string tablist_description
string timer_description
string title_by
string title_secured_by_passbase
string toolbar_description
string tooltipAdditionalDocument
string tooltipDocument
string tooltipEmail
string tooltipLocation
string tooltipSelfieVideo
string tryAgain
string turnCovidVaccinationCard
string turnDriversLicenseBack
string turnDriversLicenseFront
string turnHealthInsuranceBack
string turnHealthInsuranceFront
string turnNationalIDBack
string turnNationalIDFront
string turnPassport
string turnProofOfAddress
string type_country
string uploadFailed
string uploaded
string verifyMe
...
style MBVerificationInstructions
style MBVerificationInstructions_Text
style MBVerificationSplashText
style MBViewfinderShape
style MBViewfinderShape_Document
style MB_blinkid_instructions_text
style MB_default_reticle_overlay_style
style MB_default_scan_box_overlay_style
style MB_default_simple_box_overlay_style
style MB_glare_message_text
style MB_scan_status_text
style MB_snackbar_text
style MB_theme
style MB_top_button
style MB_top_button_bar
...
style PassbaseCircleBig
style PassbaseCircleMiddle
style PassbaseCircleSmall
style PassbaseLogo
...
styleable ActionButton color colorText loading text textSize width
...
styleable AspectRatioFrameLayout mb_aspectRatio
styleable Badge backgroundColor badgeGravity badgeTextColor maxCharacterCount number
styleable BlinkCardEditScreen mb_blinkcardEditConfirmButtonStyle mb_blinkcardEditDividerColor mb_blinkcardEditErrorColor mb_blinkcardEditErrorTextAppearance mb_blinkcardEditLabelTextAppearance mb_blinkcardEditLabelTextColor mb_blinkcardEditToolbarBackground mb_blinkcardEditToolbarNavigationIcon mb_blinkcardEditToolbarTheme mb_blinkcardEditValueHintColor mb_blinkcardEditValueTextAppearance mb_blinkcardEditValueTextColor
styleable BlinkCardScanLineOverlay mb_exitScanDrawable mb_glareWarningBackgroundDrawable mb_glareWarningTextAppearance mb_instructionsTextAppearance mb_torchOffDrawable mb_torchOnDrawable
styleable BlinkIdReticleOverlay mb_cardBackDrawable mb_cardFrontDrawable mb_exitScanDrawable mb_flashlightWarningBackgroundDrawable mb_flashlightWarningTextAppearance mb_instructionsBackgroundDrawable mb_instructionsTextAppearance mb_progressDrawable mb_pulseColor mb_reticleDefaultDrawable mb_reticleErrorDrawable mb_reticleSuccessDrawable mb_successFlashColor mb_torchOffDrawable mb_torchOnDrawable
styleable BlinkIdScanBoxOverlay mb_backSideInstructionsDrawable mb_backSideSplashDrawable mb_exitScanDrawable mb_frontSideInstructionsDrawable mb_frontSideSplashDrawable mb_torchOffDrawable mb_torchOnDrawable
styleable BlinkIdSimpleBoxOverlay mb_exitScanDrawable mb_torchOffDrawable mb_torchOnDrawable
styleable BlinkidCameraOverlay mb_errorHookColor mb_flipCardColor mb_hookColor mb_overlayColor mb_scanLineColor mb_viewfinderAspectRatio
...
styleable CameraViewGroup mb_animateRotation mb_animationDuration
styleable CameraViewGroup_LayoutParams mb_rotatable
...
styleable DocumentCaptureDetectionOverlay mb_captureButtonDrawable mb_detectionRectangleColor mb_exitScanDrawable mb_instructionsBackgroundDrawable mb_instructionsTextAppearance mb_successFlashColor mb_torchOffDrawable mb_torchOnDrawable
...
styleable GlobalAttrs mb_animateRotation mb_animationDuration mb_aspectRatio mb_backSideInstructionsDrawable mb_backSideSplashDrawable mb_blinkcardEditConfirmButtonStyle mb_blinkcardEditDividerColor mb_blinkcardEditErrorColor mb_blinkcardEditErrorTextAppearance mb_blinkcardEditLabelTextAppearance mb_blinkcardEditLabelTextColor mb_blinkcardEditToolbarBackground mb_blinkcardEditToolbarNavigationIcon mb_blinkcardEditToolbarTheme mb_blinkcardEditValueHintColor mb_blinkcardEditValueTextAppearance mb_blinkcardEditValueTextColor mb_btnCornerRadius mb_btnTimeoutColor mb_btnTimeoutTextAppearance mb_captureButtonDrawable mb_cardBackDrawable mb_cardFrontDrawable mb_circleCheckFailedColor mb_circleColor mb_circleOuterColor mb_circleProgressColor mb_circleSuccessColor mb_detectionRectangleColor mb_errorHookColor mb_errorIcon mb_exitScanDrawable mb_flashlightWarningBackgroundDrawable mb_flashlightWarningTextAppearance mb_flipCardColor mb_frontSideInstructionsDrawable mb_frontSideSplashDrawable mb_glareWarningBackgroundDrawable mb_glareWarningTextAppearance mb_hookColor mb_instructionsBackgroundDrawable mb_instructionsTextAppearance mb_overlayColor mb_progressDrawable mb_pulseColor mb_reticleDefaultDrawable mb_reticleErrorDrawable mb_reticleSuccessDrawable mb_rotatable mb_scanLineColor mb_successFlashColor mb_successIcon mb_torchOffDrawable mb_torchOnDrawable mb_viewfinderAspectRatio
...
styleable LivenessOverlay mb_btnCornerRadius mb_btnTimeoutColor mb_btnTimeoutTextAppearance mb_circleCheckFailedColor mb_circleColor mb_circleOuterColor mb_circleProgressColor mb_circleSuccessColor mb_errorIcon mb_exitScanDrawable mb_instructionsTextAppearance mb_successFlashColor mb_successIcon mb_torchOffDrawable mb_torchOnDrawable
...
styleable PBToolbarView showBackButton showCloseButton showLogo showTitle
styleable PassbaseButton backgroundColor textColor
...
styleable ViewfinderShapeView mb_borderColor mb_borderWidth mb_cornerRadius mb_innerColor mb_outerColor mb_shapeType
